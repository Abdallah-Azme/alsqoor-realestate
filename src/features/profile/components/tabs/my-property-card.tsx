    ...
    >
      ...
      >
        ...
        <div className="p-4 flex flex-col flex-1">
          ...
          {/* Title */}
          <h3 className="font-bold text-gray-900 mb-1 line-clamp-1 min-h-6 group-hover/card:text-main-green transition-colors">
            {property.title}
          </h3>
          ...
          {showConvertButton && (
            ...
            >
              <ConvertPropertyToAdDialog
                property={property as any}
                trigger={
                  <button className="w-full h-full bg-main-green text-white hover:bg-main-green/90 disabled:bg-gray-300 font-medium py-2 rounded-lg transition-all flex items-center justify-center gap-2 text-sm shadow-sm">
                    {t("make_it_ad")}
                  </button>
                }
              />
