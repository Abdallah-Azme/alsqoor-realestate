...
function FilterField({
  ...
  return (
    <div className="flex-1 w-full flex items-start gap-3 px-4 py-3 rounded-xl hover:bg-gray-50 border border-transparent hover:border-gray-100 transition-colors group">
      <div className="mt-1 shrink-0 group-hover:scale-110 group-hover:text-main-green transition-transform duration-200">
        {icon}
      </div>
      <div className="flex-1 flex flex-col">
        <span className="text-[11px] font-bold text-gray-400/80 uppercase tracking-wider mb-1 block">
          {label}
        </span>
...
export default function AdsPageFilter() {
  ...
  return (
    <div className="w-full max-w-6xl mx-auto mb-10">
      {/* Sale / Rent Tabs - Floating Style */}
      <div className="flex -mb-px relative z-10 w-full md:w-auto md:inline-flex px-4 md:px-0">
        <div className="flex w-full md:w-auto bg-white/70 backdrop-blur-md p-1.5 rounded-t-2xl gap-2 border border-b-0 border-gray-200/60 shadow-[0_-8px_20px_rgba(0,0,0,0.02)]">
          {(["sale", "rent"] as const).map((type) => (
            <button
              ...
              className={cn(
                "relative flex-1 md:flex-none px-10 py-3 rounded-xl text-sm font-bold transition-all duration-300",
                operationType === type
                  ? "text-main-green"
            ...
            >
              {operationType === type && (
                <motion.div
                  ...
                  className="absolute inset-0 bg-main-green/10 rounded-xl border border-main-green/20"
      ...
      {/* Main Filter Body */}
      <div className="bg-white p-2 md:p-3 rounded-3xl rounded-tr-none md:rounded-tr-2xl shadow-[0_20px_50px_rgba(0,0,0,0.05)] border border-gray-100 relative z-20">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-1 p-2">
          {/* Ad ID */}
          <FilterField
            label="رقم الإعلان (ID)"
            icon={<BsHash className="text-gray-400 w-5 h-5 shrink-0" />}
          >
            <Input
              placeholder="مثال: 3"
              value={formData.id}
              onChange={(e) => updateField("id", e.target.value)}
              className="border-none shadow-none focus-visible:ring-0 p-0 h-auto bg-transparent text-main-navy font-semibold w-full placeholder:text-gray-300 placeholder:font-normal"
            />
          </FilterField>
          ...
          <FilterField
            label="نوع العقار"
            icon={<BsHouse className="text-gray-400 w-5 h-5 shrink-0" />}
          >
            <Select
          ...
          <FilterField
            ...
            icon={<BsMap className="text-gray-400 w-5 h-5 shrink-0" />}
          >
            <Select
          ...
          <FilterField
            ...
            icon={<BsGeoAlt className="text-gray-400 w-5 h-5 shrink-0" />}
          >
            <Input
          ...
          <FilterField
            ...
            icon={
              <BsArrowsFullscreen className="text-gray-400 w-5 h-5 shrink-0" />
            }
          >
          ...
          <FilterField
            ...
            icon={<BsDoorOpen className="text-gray-400 w-5 h-5 shrink-0" />}
          >
            <Select
          ...
          <FilterField
            ...
            icon={<BsDroplet className="text-gray-400 w-5 h-5 shrink-0" />}
          >
            <Select
          ...
          <FilterField
            ...
            icon={<BsLayers className="text-gray-400 w-5 h-5 shrink-0" />}
          >
            <Select
        ...
        <div className="w-full flex justify-end mt-2 p-4 pt-2 border-t border-gray-100 mt-2">
          ...
          >
            <Search className="w-5 h-5 ml-2 rtl:ml-0 rtl:mr-2 group-hover:scale-110 transition-transform" />
            بحث وتصفية
          </Button>
        </div>
      </div>
